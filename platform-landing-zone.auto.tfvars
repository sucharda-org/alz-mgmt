...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "msucharda@microsoft.com"
    ...
    # Resource provisioning primary connectivity (no on-prem)
    ...
    # IP Ranges Primary (from SLZ design: 10.25.0.0/16)
    primary_hub_address_space                          = "10.25.0.0/23"
    primary_sidecar_virtual_network_address_space      = "10.25.2.0/23"
    primary_bastion_subnet_address_prefix              = "10.25.2.64/26"
    primary_private_dns_resolver_subnet_address_prefix = "10.25.2.128/28"
  }
